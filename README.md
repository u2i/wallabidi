...
- **[API](guides/api.md)** — queries and actions, navigation, finding, forms, assertions, screenshots, dialogs, `settle`, `intercept_request`, `on_console`.
...
navigation, finding, forms, assertions, window size, screenshots, JavaScript logging,
dialogs, `settle`, `intercept_request`, and `on_console`.
